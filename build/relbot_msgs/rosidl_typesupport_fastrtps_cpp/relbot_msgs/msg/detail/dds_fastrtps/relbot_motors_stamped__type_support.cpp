  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: motor_cmd
  relbot_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.motor_cmd,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_cmd
  current_alignment +=
    relbot_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.motor_cmd, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        relbot_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_RelbotMotors(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
