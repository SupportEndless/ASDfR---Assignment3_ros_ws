...
#include "relbot_msgs/msg/detail/relbot_motors_stamped__rosidl_typesupport_fastrtps_c.h"
...
#include "relbot_msgs/msg/detail/relbot_motors__functions.h"  // motor_cmd
...
static size_t _RelbotMotorsStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_relbot_msgs__msg__RelbotMotorsStamped(
...
static message_type_support_callbacks_t __callbacks_RelbotMotorsStamped = {
  "relbot_msgs::msg",
  "RelbotMotorsStamped",
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, relbot_msgs, msg, RelbotMotorsStamped)() {
  return &_RelbotMotorsStamped__type_support;
}
