...
static const _RelbotMotors_type_support_symbol_names_t _RelbotMotors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, relbot_msgs, msg, RelbotMotors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, relbot_msgs, msg, RelbotMotors)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, relbot_msgs, msg, RelbotMotors)() {
  return &::relbot_msgs::msg::rosidl_typesupport_c::RelbotMotors_message_type_support_handle;
}
