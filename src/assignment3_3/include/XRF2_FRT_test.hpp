...
public:
    ...
    ~XRF2_FRT_test();
private:
    constexpr double COUNTS_PER_MOTOR_REV = 4096.0;
    constexpr double GEAR_RATIO           = 15.58;
    constexpr double counts_to_rad = 2.0 * M_PI  / (COUNTS_PER_MOTOR_REV * GEAR_RATIO);  // Amount of counts in one rad (wheel)
