...
relbot_msgs__msg__RelbotMotors__create(void)
{
  ...
  memset(msg, 0, sizeof(relbot_msgs__msg__RelbotMotors));
  bool success = relbot_msgs__msg__RelbotMotors__init(msg);
  if (!success) {
...
relbot_msgs__msg__RelbotMotors__destroy(relbot_msgs__msg__RelbotMotors * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    relbot_msgs__msg__RelbotMotors__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
relbot_msgs__msg__RelbotMotors__Sequence__init(relbot_msgs__msg__RelbotMotors__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  relbot_msgs__msg__RelbotMotors * data = NULL;

  if (size) {
    data = (relbot_msgs__msg__RelbotMotors *)allocator.zero_allocate(size, sizeof(relbot_msgs__msg__RelbotMotors), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = relbot_msgs__msg__RelbotMotors__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        relbot_msgs__msg__RelbotMotors__fini(&data[i - 1]);
      }
...
relbot_msgs__msg__RelbotMotors__Sequence__fini(relbot_msgs__msg__RelbotMotors__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      relbot_msgs__msg__RelbotMotors__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  relbot_msgs__msg__RelbotMotors__Sequence * array = (relbot_msgs__msg__RelbotMotors__Sequence *)allocator.allocate(sizeof(relbot_msgs__msg__RelbotMotors__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = relbot_msgs__msg__RelbotMotors__Sequence__init(array, size);
  if (!success) {
...
relbot_msgs__msg__RelbotMotors__Sequence__destroy(relbot_msgs__msg__RelbotMotors__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    relbot_msgs__msg__RelbotMotors__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
relbot_msgs__msg__RelbotMotors__Sequence__are_equal(const relbot_msgs__msg__RelbotMotors__Sequence * lhs, const relbot_msgs__msg__RelbotMotors__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!relbot_msgs__msg__RelbotMotors__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  relbot_msgs__msg__RelbotMotors__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(relbot_msgs__msg__RelbotMotors);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    relbot_msgs__msg__RelbotMotors * data =
      (relbot_msgs__msg__RelbotMotors *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!relbot_msgs__msg__RelbotMotors__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          relbot_msgs__msg__RelbotMotors__fini(&output->data[i]);
        }
        return false;
      }
    }
